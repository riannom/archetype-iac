"""Timing utilities for agent operation performance measurement.
...
Usage:
    from agent.timing import TimedOperation
    from agent.metrics import docker_api_duration

    with TimedOperation(
        histogram=docker_api_duration,
        labels={"operation": "start"},
        log_event="docker_api",
    ):
        container.start()
"""
...
class TimedOperation:
    ...
    Both metric recording and logging are exception-guarded.
    """
