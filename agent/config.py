...
class Settings(BaseSettings):
    ...
    # Default False: ISO config delivery replaces POAP for startup-config.
    ...
    n9kv_boot_modifications_enabled: bool = True
    ...
    overlay_mtu: int = 1450  # MTU for VXLAN tenant interfaces (underlay MTU - 50 byte overhead)
