...
class Settings(BaseSettings):
    ...
    overlay_mtu: int = 9000  # MTU presented to overlay tenant interfaces (VXLAN device MTU)
    # With df=unset, the kernel fragments oversized outer packets transparently,
    # so this can exceed the underlay MTU. Containers see full jumbo frame support.
