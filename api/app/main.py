...
from app.routers import admin, agents, auth, callbacks, console, dashboard, events, images, infrastructure, iso, jobs, lab_tests, labs, permissions, state_ws, support, system, users, vendors, webhooks
