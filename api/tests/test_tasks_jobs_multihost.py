...
class TestMultihostDeployDispatch:
    ...
    async def test_three_nodes_on_two_hosts(
        ...
        job = make_job(test_db, lab, test_user)
        make_node(test_db, lab, gui_id="n1", name="r1", host_id=host1.id)
        make_node(test_db, lab, gui_id="n2", name="r2", host_id=host1.id)
        make_node(test_db, lab, gui_id="n3", name="r3", host_id=host2.id)
...
class TestMultihostDeployUnplacedNodes:
    ...
    async def test_mixed_placed_and_unplaced(
        ...
        job = make_job(test_db, lab, test_user)
        make_node(test_db, lab, gui_id="n1", name="r1", host_id=host1.id)
        unplaced = make_node(test_db, lab, gui_id="n2", name="r2", host_id=None)
...
class TestMultihostDeployAgentFailures:
    ...
    async def test_missing_host_record_fails(self, test_db: Session, test_user):
        ...
        lab = make_lab(test_db, test_user)
        job = make_job(test_db, lab, test_user)
        make_node(test_db, lab, gui_id="n1", name="r1", host_id="ghost-host-id")
    ...
    async def test_offline_agent_fails_job(
        ...
        lab = make_lab(test_db, test_user)
        job = make_job(test_db, lab, test_user)
        make_node(test_db, lab, gui_id="n1", name="r1", host_id=host3.id)
...
class TestMultihostDestroyExceptions:
    ...
    async def test_missing_host_record_during_destroy(
        ...
        lab = make_lab(test_db, test_user, state="running")
        job = make_job(test_db, lab, test_user, action="down")
        make_node(test_db, lab, gui_id="n1", name="r1", host_id="ghost-agent")
