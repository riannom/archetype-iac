                ...
                >
                  <div className="flex items-start justify-between">
                    ...
                    <div className="text-right">
                      <div className="text-xs text-stone-500">Latest</div>
                      <div className="text-xs text-stone-400 mt-1">
              ...
              {deviceNodes.map((node) => {
                ...
                return (
                  <button
                    ...
                    className={`w-full text-left p-4 rounded-lg border-2 transition-all ${
                      isCompatible
                        ? 'border-sage-200 bg-white hover:border-sage-400 hover:shadow-sm cursor-pointer'
          ...
          <div className="bg-white rounded-lg shadow-xl max-w-md w-full mx-4 p-6">
            ...
            <div className="space-y-3 text-sm text-stone-700">
              ...
              <div className="bg-stone-50 p-3 rounded border border-stone-200">
                <div className="text-xs text-stone-500 mb-1">Device Type</div>
                <div className="font-medium">{selectedOrphan.deviceKind}</div>
              </div>
              <div className="bg-stone-50 p-3 rounded border border-stone-200">
                <div className="text-xs text-stone-500 mb-1">Action</div>
                <div>
            ...
            <div className="flex justify-end gap-3 mt-6">
              <button
                ...
                disabled={isMapping}
                className="px-4 py-2 text-sm font-medium text-stone-700 bg-white border border-stone-300 rounded-md hover:bg-stone-50 disabled:opacity-50"
              >
                Cancel
              </button>
              <button
