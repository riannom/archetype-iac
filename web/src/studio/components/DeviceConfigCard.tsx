      ...
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center gap-2 mt-1">
            <span className="text-[11px] text-stone-800 dark:text-stone-400 font-medium">
              {device.vendor}
            </span>
            <span className="w-1 h-1 rounded-full bg-stone-300 dark:bg-stone-600"></span>
            <span className="text-[11px] text-stone-700 dark:text-stone-500 font-mono">
              {device.id}
            </span>
            <span className="w-1 h-1 rounded-full bg-stone-300 dark:bg-stone-600"></span>
            <span className="text-[11px] text-stone-700 dark:text-stone-500 capitalize">
              {device.type}
            </span>
          </div>
          ...
          <div className="flex items-center gap-3 mt-2">
            <div className="flex items-center gap-1 text-[11px] text-stone-800 dark:text-stone-500">
