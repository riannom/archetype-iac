...
export const DEVICE_CATEGORIES: DeviceCategory[] = [
  {
    ...
    subCategories: [
      ...
      },
      {
        name: 'Switches',
        models: [
          // Canonical ID is "ceos" (Arista cEOS). "eos" is treated as an alias.
          { id: 'ceos', type: DeviceType.SWITCH, vendor: 'Arista', name: 'Arista cEOS', icon: 'fa-arrows-left-right-to-line', versions: ['4.35.1F', '4.28.0F', '4.27.1F'], isActive: true },
